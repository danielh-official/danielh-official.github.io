...
@section("body")
    <h3 class="mb-4 flex flex-col text-2xl font-bold">
    ...
    >
        <ul class="list-disc pl-6">
            <li>
                Developed and maintained web applications using Laravel, Vue.js,
                and Tailwind CSS.
            </li>
            <li>
                Implemented RESTful APIs for data exchange between frontend and
                backend systems.
            </li>
            <li>
    ...
    <div class="flex flex-col">
        ...
        <div class="italic">
            Bachelor of Science in Business Analytics and Information Technology
        </div>
        <div>2013 - 2018</div>
    </div>
@endsection
