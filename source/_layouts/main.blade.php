...
<html lang="en">
    ...
    <body class="flex flex-col justify-between min-h-screen font-sans leading-normal text-gray-800 bg-gray-100 dark:bg-gray-900 dark:text-gray-200">
            ...
            <div class="container flex items-center px-4 mx-auto max-w-8xl lg:px-8">
                <div class="flex items-center">
                    <a href="/" title="{{ $page->siteName }} home" class="inline-flex items-center">
                        ...
                        <h1 class="my-0 text-lg font-semibold text-blue-800 dark:text-blue-400 md:text-2xl hover:text-blue-600">{{ $page->siteName }}</h1>
                    </a>
                </div>
