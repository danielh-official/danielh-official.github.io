...
<body
    ...
    <header class="flex h-24 items-center border-b py-4 shadow" role="banner">
        <div class="max-w-8xl container mx-auto flex items-center px-4 lg:px-8">
            <div class="flex items-center">
                <a href="/" title="{{ $page->siteName }} home" class="inline-flex items-center">
                    <img class="mr-3 h-8 md:h-10" src="/assets/img/logo.svg" alt="{{ $page->siteName }} logo" />
                </a>
            </div>
    ...
    <footer class="mt-12 py-4 text-center text-sm" role="contentinfo">
        <ul class="flex list-none flex-col justify-center md:flex-row">
            ...
            <l class="md:mr-2">
                ...
                and
                <a href="https://tailwindcss.com" title="Tailwind CSS, a utility-first CSS framework">
                    Tailwind CSS
                </a>
                .
            </l>
