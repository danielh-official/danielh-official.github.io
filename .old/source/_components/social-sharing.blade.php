<div class="mt-8 flex items-center space-x-4 border-t border-gray-200 pt-4">
  <span class="text-sm text-gray-600">Share this post:</span>

  <a
    href="https://twitter.com/intent/tweet?text={{ urlencode($page->title) }}&url={{ urlencode($page->getUrl()) }}"
    target="_blank"
  ...
  <a
    href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode($page->getUrl()) }}"
    target="_blank"
    rel="noopener noreferrer"
